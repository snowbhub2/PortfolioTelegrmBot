...
const translations = {
  ru: {
    ...
    'settings.max': 'Макси',
    'settings.not_applies': 'Не распространяется на аккаун�� CFD Space.',
    ...
    'wallet.assets.boughtAt': '��упили за:',
    ...
    'bonuses.empty.completed': 'Нет завершё��ных бонусов',
