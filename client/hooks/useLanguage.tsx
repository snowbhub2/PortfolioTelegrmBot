...
const translations = {
  ru: {
    ...
    'notifications.category.feedback_desc': 'Опросы пользователей, которые помогают ��лучшить сервис.',
    ...
    'wallet.assets.dollars_cash': 'Доллары (наличны��)',
    ...
    'withdraw.method.telegram.description': 'Мгновенно и без к��миссий',
