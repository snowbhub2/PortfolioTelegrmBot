...
const translations = {
  ru: {
    ...
    'notifications.cfd_desc': 'Получайте уведомления, когд�� вам приходят CFD токены и NFT в CFD К��шелёк.',
    ...
    'coin.xrp_point_2': 'XRP вико��истовується банками та фінансовими установами для швидких переказів.',
    ...
    'common.recommended': '��екомендуемые',
