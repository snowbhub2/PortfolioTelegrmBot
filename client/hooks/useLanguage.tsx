...
const translations = {
  ru: {
    ...
    'notifications.cfd_title': 'УВЕДОМЛЕНИЯ CFD КО��ЕЛЬКА',
    ...
    'wallet.assets.cashDollars': 'Доллары (наличка)',
  ...
  en: {
    ...
    'wallet.portfolio_balance': 'Portfolio Balance',
    'wallet.all_time': 'all time',
    ...
    'wallet.in_trend': 'TRENDING',
    'wallet.assets': 'ASSETS',
    'wallet.view_all': 'All',
    'wallet.show': 'Show',
    'wallet.hide': 'Hide',
    'wallet.no_assets': 'No assets yet',
    'wallet.buy_on_market': 'Buy assets on Market page',
    'wallet.start_trading': 'Start trading to see your assets here',
    'wallet.dollars_cash': 'Dollars (cash)',
    'wallet.for_trading': 'For trading',
    'wallet.bought_for': 'Bought for:',
    'wallet.per_day': 'per day',
    'wallet.earn_apy': 'Earn up to 15% APY',
    'wallet.with_dollars': 'with dollars',
    'wallet.start_earning': 'Start earning →',
    'wallet.current_price': 'Current price',
    'wallet.buy': 'BUY',
    'wallet.sell': 'SELL',
    'wallet.trading_warning': 'Cryptocurrency trading involves high risks',
    'wallet.demo_mode': '🎭 Demo mode - for full features launch via Telegram bot',
    'wallet.open_settings': 'Open settings',
    'wallet.trading': 'Trading',
    'wallet.cfd': 'CFD',
