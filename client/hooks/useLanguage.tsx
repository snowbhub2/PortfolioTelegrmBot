...
const translations = {
  ru: {
    ...
    'notifications.cfd_title': 'УВЕДОМЛЕНИЯ CFD КОШЕЛ��КА',
    ...
    'deposit.address.qr_description': 'Отсканируйте QR-ко�� для отправки',
    ...
    'history.start_trading': 'Начните торговать, чтобы увидеть и��торию здесь',
    ...
    'transfer.amount_label': 'Сумма перевода',
