...
const translations = {
  ru: {
    ...
    'settings.currency': 'Осн��вная валюта',
    ...
    'settings.walletNews': 'Новости Кошель��а',
    ...
    'wallet.assets.noAssets': 'Пока не�� активов',
    ...
    'wallet.notification.startEarning': 'Начать зарабатывать →',
    'wallet.trending.perDay': 'за день',
    'wallet.demo.message': '🎭 Demo режим - для полных фу��кций запустите через Telegram бота',
    'wallet.settings.open': 'Открыть настройки',
    ...
    'bonuses.hero.subtitle': '��олучайте бонусы за хра��ение криптовалюты.',
