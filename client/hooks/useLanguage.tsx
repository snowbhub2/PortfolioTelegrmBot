...
const translations = {
  ru: {
    ...
    'settings.footer_text2': 'Сервис независ��м и не ��вя��ан с Telegram.',
    ...
    'deposit.method.p2p_market_desc': 'Купить б��з посре��ников',
    ...
    'asset.not_in_portfolio': 'Нет активов в по����феле',
    ...
    'coin.btc_point_1': 'Ви можете купувати, продавати або зберіг��ти BTC в Гаманці.',
    ...
    'coin.xrp_point_2': 'XRP використовується банк��ми та фінансовими установами для швидких переказів.',
    ...
    'exchange.title': 'Обмен',
    'exchange.you_pay': 'Вы платите',
    'exchange.you_receive': 'Вы полу��аете',
    'exchange.rate': 'Курс',
