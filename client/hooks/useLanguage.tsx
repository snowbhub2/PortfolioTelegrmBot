...
const translations = {
  ru: {
    ...
    'wallet.demo.message': '🎭 Demo режим - для полных функций запустите через Telegram бота',
    'wallet.settings.open': 'Открыть ��а��тройки',
    ...
    'deposit.network.warning': 'Убедитесь, что вы выбрали нужную сеть. Неверный выбор может при��ест�� к утрате средств.',
    ...
    'exchange.insufficient_funds': 'Недос��аточно средств.',
    ...
    'transfer.info.cfd_desc': 'CFD - средств�� для контрактов на разность цен',
