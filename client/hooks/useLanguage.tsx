...
const translations = {
  ru: {
    ...
    'wallet.assets.dollars_cash': 'Д��ллары (наличные)',
    ...
    'withdraw.processing.recipient': 'Получате��ь',
    ...
    'asset.header.mini_app': 'мін��Застосунок',
    ...
    'coin.about_precious_metal': 'ПРО Д��РОГОЦІННИЙ МЕТАЛ',
    ...
    'coin.eth_point_1': 'Ви можете купувати, продавати ��бо зберігати ETH в Гаманці.',
  ...
  en: {
    ...
    'settings.walletFAQ': 'Wallet FAQ',
    'settings.walletNews': 'Wallet News',
