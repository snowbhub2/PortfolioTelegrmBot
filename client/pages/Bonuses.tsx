...
export default function Bonuses() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground pb-20 sm:min-h-screen sm:pb-20" style={{ minHeight: '822px', paddingBottom: '79px' }} data-mobile-styles="min-h-[822px] pb-[79px]">
      {/* Empty Header */}
