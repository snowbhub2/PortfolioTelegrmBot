    ...
    switch (asset.category) {
        ...
        if (asset.id === "gold") {
          ...
          return {
            ...
            points: [
              ...
              "Платина рідше за золото та має вис��ку стійкість до корозії."
            ]
          };
        } else {
          return {
      ...
      case "currency":
        if (asset.id === "usd") {
          return {
            title: "ПРО ВАЛЮТУ",
            description: "Долар США — це основна резервна валюта світу та ��азова валюта для торгі��лі на нашій платформі.",
            points: [
          ...
          return {
            title: "ПРО ВАЛЮТУ",
            description: `${asset.name} — це валюта, доступна для опера��ій на нашій платформі.`,
            points: [
      ...
      default:
        return {
          ...
          points: [
            `Ви можете купувати або продавати ${asset.symbol} через платформу.`,
            "Бу��ь ласка, врахуйте ризики при інвестуванні."
          ]
        };
    }
  };
