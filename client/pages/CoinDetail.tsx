  ...
  const getAssetInfo = () => {
    switch (asset.category) {
      case "crypto":
        if (asset.id === "btc") {
          ...
          return {
            ...
            points: [
              "Ви можете купувати, продавати або збе��ігати TON в Гаманці.",
      ...
      case "stocks":
        if (asset.id === "aapl") {
          return {
            ...
            points: [
              "Ви можете купувати або продавати акції AAPL через платф��рму.",
      ...
      default:
        return {
          title: "ПРО АКТИВ",
          description: `${asset.name} — це фінансовий інструмент, доступний для торгі��лі на нашій платформі.`,
          points: [
            `Ви можете купувати або продавати ${asset.symbol} через платформу.`,
