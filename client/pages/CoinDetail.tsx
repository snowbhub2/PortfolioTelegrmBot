      ...
      case "crypto":
        if (asset.id === "btc") {
          ...
          return {
            ...
            points: [
              "Ви можете купувати, продавати або зберігати XRP в Г��манці.",
      ...
      case "stocks":
        if (asset.id === "aapl") {
          return {
            ...
            points: [
              "Ви можете купувати або продавати а��ції AAPL через платформу.",
          ...
          return {
            ...
            points: [
              ...
              "Ціни на акції можуть коливатися залежно від ринк��вих умов."
            ]
          };
        }
