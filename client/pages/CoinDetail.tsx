    ...
    switch (asset.category) {
      ...
      case "gold":
        if (asset.id === "gold") {
          ...
          return {
            title: "ПРО ДОРОГОЦІННИЙ МЕТАЛ",
            description: "Срібло — це дорогоцінний метал з широким промисловим застосува��ням, популярний серед інвесторів як альтернатива золоту.",
            points: [
      ...
      case "currency":
        if (asset.id === "usd") {
          ...
          return {
            ...
            points: [
              `В�� можете здійснювати операції з ${asset.symbol} через платформу.`,
