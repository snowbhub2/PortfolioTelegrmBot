...
export default function CoinDetail() {
      ...
      case "crypto":
        if (asset.id === "btc") {
          ...
          return {
            ...
            description: "Toncoin — это криптовалюта блокчейна TON (The Open Network), который изначально разрабатывался командой Telegram.",
            points: [
              "Вы можете покупать, продавать или хранить TON в Кошельке.",
              "TON известен своей высокой скоростью транзакций и низкими комиссиями."
            ]
          };
        } else if (asset.id === "sol") {
          return {
            title: "О ��РИПТОВАЛЮТЕ",
            description: "Solana — это высокопроизводительный блокчейн, известный своей скоростью и низкими комиссиями за транзакции.",
            points: [
              "Вы можете покупать, продавать или хранить SOL в Кошельке.",
              "Solana поддерживает децентрализованные приложения и смарт-контракты."
            ]
          };
        } else if (asset.id === "xrp") {
          return {
            title: "О КРИПТОВАЛЮТЕ",
            description: "XRP — это цифровая валюта, созданная компанией Ripple для мгновенных международных переводов и платежей.",
            points: [
              "Вы можете покупать, продавать или хранить XRP в Кошельке.",
              "XRP используется банками и финансовыми учреждениями для быстрых переводов."
            ]
          };
        } else {
          return {
      ...
      case "stocks":
        if (asset.id === "aapl") {
          ...
          return {
            ...
            points: [
              "Ви мо��ете купувати або продавати акції GOOGL через платформу.",
      ...
      case "gold":
        if (asset.id === "gold") {
          ...
          return {
            ...
            description: "Срібло — це до��огоцінний метал з широким промисловим застосуванням, популярний серед інвесторів як альтернатива золоту.",
            points: [
  ...
  const handleBuySuccess = () => {
    ...
    // Портфель автоматично онов��ться через реактивність
  };
