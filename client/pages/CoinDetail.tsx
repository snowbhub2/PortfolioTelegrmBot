    ...
    switch (asset.category) {
      case "crypto":
        if (asset.id === "btc") {
          ...
          return {
            title: "О КРИПТОВАЛЮТЕ",
            description: "Ethereum — це платфо��ма для розумних контрактів і децентралізованих додатків (DApps), запущена в 2015 році.",
            points: [
          ...
          return {
            title: "О КРИПТОВАЛЮТЕ",
            description: "Solana — це високопродуктивний блокчейн, відомий своєю швидкістю та низькими ��омісіями за транзакції.",
            points: [
      ...
      case "stocks":
        if (asset.id === "aapl") {
          ...
          return {
            title: "ПРО АКЦІЮ",
            description: "Tesla, Inc. — американська компанія, що спеціалізується на електромобілях, накопичувачах енергії та ��онячних панелях.",
            points: [
        ...
        if (asset.id === "gold") {
          ...
          return {
            ...
            points: [
              ...
              "Платин�� рідше за золото та має високу стійкість до корозії."
            ]
          };
        } else {
          return {
