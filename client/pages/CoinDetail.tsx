    ...
    switch (asset.category) {
        ...
        if (asset.id === "btc") {
          return {
            ...
            points: [
              ...
              "Bitcoin використовує технологію блокчейн для забезпече��ня безпеки та прозорості."
            ]
          };
          ...
          return {
            ...
            points: [
              "Ви можете купувати, продавати або зберіг��ти SOL в Гаманці.",
          ...
          return {
            title: "О КРИПТОВАЛЮТЕ",
            description: "XRP — це цифрова валюта, створена компані��ю Ripple для миттєвих міжнародних переказів та платежів.",
            points: [
      ...
      case "stocks":
        if (asset.id === "aapl") {
          return {
            title: "ПРО АКЦІЮ",
            description: "Apple Inc. — американська багатонаціональна технологіч��а корпорація, відома своїми продуктами iPhone, iPad, Mac та іншими пристроями.",
            points: [
          ...
          return {
            title: "ПРО АКЦІЮ",
            description: "Microsoft Corporation — американська багатонаціональна техн��логічна корпорація, розробник програмного забезпечення та хмарних сервісів.",
            points: [
      ...
      case "gold":
        if (asset.id === "gold") {
          ...
          return {
            title: "ПРО ДОРОГОЦІННИЙ МЕТАЛ",
            description: "Срібло — це дорогоцінний метал з широким промисловим застосуванням, по��улярний серед інвесторів як альтернатива золоту.",
            points: [
      ...
      case "currency":
        if (asset.id === "usd") {
          return {
            title: "ПРО ВАЛЮТУ",
            description: "Долар США — це основна резервна валюта світу та базова валюта для торгі��лі на нашій платформі.",
            points: [
          ...
          return {
            ...
            points: [
              ...
              "Валютні курси можуть коливатися залежно від ��инкових умов."
            ]
          };
        }
